...
output: 
  html_document:
    ...
    theme: paper
    highlight: pygments
    pandoc_args: --output=05_Regression_Evaluation_answers.html
---
...
- enclose all files of the project `05_Regression_Evaluation.Rproj` (i.e. all `.R` and/or `.Rmd` files including the one with your answers, and the `.Rproj` file) in a zip file, and 

- hand in the zip [here](https://uu.blackboard.com/webapps/blackboard/content/listContentEditable.jsp?content_id=_4472168_1&course_id=_146275_1&mode=reset). Do so before Lecture 7.
