...
The goal is to predict whether someone is a user of non-user based on all other variables using the `mlr3verse`. 
...
- hand in the zip [here](https://uu.blackboard.com/webapps/blackboard/content/listContentEditable.jsp?content_id=_4472168_1&course_id=_146275_1&mode=reset). Try do so as soon as possible. 
