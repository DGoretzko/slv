...
### Assignments
Students will form groups to choose work on two assignments. Students will need to perform calculations and program code for these assignments. All work needs to be combined in an easy understandable, self-contained and insightful `RStudio` project and must be submitted to the [Course submission GitHub page](https://github.com/gerkovink/INFOMDA1-2022). Each assigment will be graded. 
