...
### Assignments
Students will form groups to choose work on two assignments. Students will need to perform calculations and program code for these assignments. All work needs to be combined in an easy understandable, self-contained and insightful `RStudio` project and must be submitted to the [Course submission GitHub page](LINK). Each assignment will be graded. 
...
Hand in by PR from your fork [here](LINK).

If you are unfamiliar with [GitHub](https://github.com), forking and/or pull-request, please study [this exercise](https://www.gerkovink.com/markup/Wk1/Exercise_1.html) from a course of our colleague. There you can find video walkthroughs that detail the process. 
