...
| When?  |         | Where?      |
|--------|---------|-------------|
| 09-Sep | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 16-Sep | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 23-Sep | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 30-Sep | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 07-Oct | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 14-Oct | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 21-Oct | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 28-Oct | 9 am | [Dalton 500 8.27](https://www.uu.nl/en/daltonlaan-500) |
| 04-Nov (**Exam**)| 5 pm | [BBG 023](https://www.uu.nl/buys-ballotgebouw) |
...
In order to pass the course, the final grade must be 5.5 or higher, your contribution to the course should be sufficient, all `R` exercises should be handed in and all assignments and the final exam must have a passing grade. Otherwise, additional work is required concerning the assignments and/or exercises you have failed.
...
Please find the [Lecture Slides here](lectures/L1/Lecture-1-new.html)
...
- [Practical 1a: Data wrangling](practicals/01_Data_Wrangling/01_Data_Wrangling.html)
- [Practical 1a: Data wrangling with answers](practicals/01_Data_Wrangling/01_Data_Wrangling_Answers.html)
...
- [Practical 1b: Data visualization](practicals/02_Data_Visualization/02_Data_Visualization.html)
...
- [ISLR V2 Chapter 1](https://www.statlearning.com)
- [R4DS Chapters 1 -3 and 9 - 16](https://r4ds.had.co.nz) 
...
- [Lecture 3](lectures/L4/week-4.pdf)
...
-[ISLR Chapter 1, 2 and 3](https://www.statlearning.com)
...
- [Lecture 4](lectures/L6/week-6.pdf)
...
- [Practical 4: Classification](practicals/06_classification/06_classification.html)
...
- [ISLR Sections 4 and 8.1 ](https://www.statlearning.com)
...
- [Lecture 5](lectures/L7/week-7.pdf)


### Practical
This week's practical is on classification. Code solutions are also given to you. Use these answers to help yourself when you're stuck.

- [Practical 5: Classification evaluation](practicals/07_classification_evaluation/07_classification_evaluation.html)
...
- [ISLR Sections 5.1, 5.2, 8.2.1, 8.2.2, 8.2.3](https://www.statlearning.com)
...
- [Lecture 6](lectures/L8/week-8.pdf)
...
- [ISLR Chapter 7](https://www.statlearning.com)
...
- [Lecture 7](lectures/L8/week-8-new.pdf)

### Practical
This week's practical is on nonlinear regression. Code solutions are also given to you. Use these answers to help yourself when you're stuck.

- [Practical 7: Tree-based methods and SVM](practicals/09_ensemble/09_ensemble.html)
...
- [ISLR Chapters 8.1, 8.2 and 9](https://www.statlearning.com)
